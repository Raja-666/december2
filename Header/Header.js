...
const Header = (props) => {
   ...
   const connectWallet = async () => {
      try {
         ...
         // Check if the user is already on the Ethereum test network (Ropsten)
         // if (networkId !== '3') {
         //    // If not on Ropsten, prompt the user to switch to the Ethereum test network
         //    const switchNetwork = window.ethereum.request({
         //       method: 'wallet_addEthereumChain',
         //       params: [{
         //          chainId: '0x3', // Ropsten network ID
         ...
         //             decimals: 18,
         //          },
         //          rpcUrls: ['https://ropsten.infura.io/v3/YOUR_INFURA_API_KEY'], // Replace with your Infura API key
         //          blockExplorerUrls: ['https://ropsten.etherscan.io/'],
         //       }],
         //    });
   
         //    // Wait for the network switch
         //    await switchNetwork;
         // }
